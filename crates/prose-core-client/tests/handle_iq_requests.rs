...
async fn test_handles_ping() -> Result<()> {
    ...
    // connection
    //     .receive_stanza(Iq::from_get("req-id", Ping).with_from(jid!("prose.org")))
    //     .await;
    //
...
async fn test_handles_entity_time_query() -> Result<()> {
    ...
    //
    // connection
    //     .receive_stanza(Iq::from_get("req-id", TimeQuery).with_from(jid!("prose.org")))
    //     .await;
    //
    // let sent_stanzas = connection.sent_stanza_strings();
    // assert_eq!(sent_stanzas.len(), 1);
...
async fn test_handles_software_version_query() -> Result<()> {
    ...
    // connection
    //     .receive_stanza(
    //         Iq::from_get("req-id", VersionQuery).with_from(jid!("client@prose.org")),
    //     )
    //     .await;
    //
    // let sent_stanzas = connection.sent_stanza_strings();
...
async fn test_handles_disco_request() -> Result<()> {
    ...
    //             .with_from(jid!("client@prose.org")),
    //     )
    //     .await;
    //
...
async fn test_handles_last_activity_request() -> Result<()> {
    ...
    // connection
    //     .receive_stanza(
    //         Iq::from_get("req-id", LastActivityRequest).with_from(jid!("client@prose.org")),
    //     )
    //     .await;
    //
    // let sent_stanzas = connection.sent_stanza_strings();
