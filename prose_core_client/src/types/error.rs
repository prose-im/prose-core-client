...
use prose_core_lib::stanza::StanzaBase;
...
impl StanzaParseError {
    pub fn missing_attribute(attribute: &str, _stanza: &impl StanzaBase) -> Self {
    ...
    pub fn missing_child_node(node_name: &str, _stanza: &impl StanzaBase) -> Self {
        // TODO: Derive a string for debugging from stanza
    ...
    pub fn missing_text(node_name: &str, _stanza: &impl StanzaBase) -> Self {
        // TODO: Derive a string for debugging from stanza
