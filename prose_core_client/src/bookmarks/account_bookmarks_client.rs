...
impl AccountBookmarksClient {
    pub fn load_bookmarks(&self) -> anyhow::Result<Vec<AccountBookmark>> {
    ...
    pub fn add_bookmark(&self, jid: &BareJid, select_bookmark: bool) -> anyhow::Result<()> {
    ...
    pub fn remove_bookmark(&self, jid: &BareJid) -> anyhow::Result<()> {
        let mut bookmarks = self.load_bookmarks()?;
    ...
    pub fn select_bookmark(&self, jid: &BareJid) -> anyhow::Result<()> {
        let mut bookmarks = self.load_bookmarks()?;
        for bookmark in bookmarks.iter_mut() {
            bookmark.is_selected = &bookmark.jid == jid;
        }
...
impl AccountBookmarksClient {
    pub fn save_bookmarks(&self, bookmarks: Vec<AccountBookmark>) -> anyhow::Result<()> {
...
mod tests {
    ...
    #[test]
    fn test_save_and_load_bookmarks() -> anyhow::Result<()> {
